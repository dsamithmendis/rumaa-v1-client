                ...
                className={`flex items-center justify-between px-3 py-2 cursor-pointer rounded-md mb-1
                  ${
                    isActive
                      ...
                      : "text-neutral-400 hover:bg-green-100 hover:text-green-700"
                  }
                `}
              >
...
function SelectedUser({ activeUser }) {
...
function ImagePreviews({ imagePreviews, removeImage }) {
...
function MessageInput({
  ...
  return (
    <div className="p-3 border-t border-gray-200 bg-white">
      <ImagePreviews imagePreviews={imagePreviews} removeImage={removeImage} />
...
export default function ChatBox({ userID, setReceiverID, chatHook, users }) {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-gray-50">
      ...
      />
      <SelectedUser activeUser={activeUser} />
